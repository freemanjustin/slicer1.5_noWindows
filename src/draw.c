...
void addText(int x, int y, char *str){
	...
	pen.x = x;
	pen.y = y;
	add_text( buffer, font, str, &color, &pen );
...
void addText2(int x, int y, char *str){
	...
	pen.x = x;
	pen.y = y;
	add_text( buffer, font_small, str, &color, &pen );
...
void draw(e *E, unsigned int scene)
{
    ...
    // HUD info
	sprintf(str,"%s\n", E->long_name);
	addText(10,E->yWinSize-E->font_size+5,lr_pack(str));	
	//printf("long name:\n");
	//printf("%s",str);	
	sprintf(str,"%2d\n",E->day);
	addText2(10,E->yWinSize-E->font_size-E->font_size_small+5,lr_pack(str));
	//printf("\nday:\n");
	//printf("%s",str);
	if(E->preview == 1)
		addText2(24,E->yWinSize-E->font_size-E->font_size_small+5,lr_pack(E->date_string));
	else
		addText2(36,E->yWinSize-E->font_size-E->font_size_small+5,lr_pack(E->date_string));
	//printf("\ndate_string:\n");
	//printf("%s", E->date_string);
